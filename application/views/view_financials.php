          ...
          <div class="card-body">
              <div class="table-responsive">
                  ...
                  $template = array(
                    ...
                    $this->table->set_heading('Id', 'Member No', 'Full Name', 'Mobile No', 'Basic Salary', 'ID Number', 'Deductions', 'Contributions', 'Pending Loans', 'Update');
                    foreach ($financials as $financial)
                    {
                        $this->table->add_row($financial['FinancialId'], $financial['MemberNo'], $financial['FullName'], $financial['MobileNo'], $financial['Salary'], $financial['IDNumber'], $financial['Deduction'], $financial['Contribution'], $financial['PendingLoans'], anchor('admin/launchfinancialupdate/'.$financial['FinancialId'], 'Update'));
                    }
