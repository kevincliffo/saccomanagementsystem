  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
           <?php 
            $obj = array('class' => 'nav-link');
           echo anchor('admin/nextofkin', '<i class="fas fa-fw fa-user-plus"></i><span> Next of Kin</span>', $obj);
           ?>
      </li>
        <li class="nav-item">
             <?php 
          ...
          <div class="card-body">
              <div class="table-responsive">
                  ...
                  $template = array(
                    ...
                    $this->table->set_heading('User Id', 'First Name', 'Last Name', 'Email', 'Registration Date');
                    foreach ($users as $user)
                    {
                        $this->table->add_row($user['UserId'], $user['FirstName'], $user['LastName'], $user['Email'], $user['CreatedDate']);
                    }
