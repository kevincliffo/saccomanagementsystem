          ...
          <div class="card-body">
              <div class="table-responsive">
                  ...
                  $template = array(
                    ...
                    $this->table->set_heading('Id','Deduction Date', 'Member No', 'Full Name', 'Salary','Deductions');
                    foreach ($deductions as $deduction)
                    {
                        $this->table->add_row($deduction['DeductionId'], $deduction['PaymentDate'], $deduction['MemberNo'], $deduction['FullName'], number_format($deduction['Salary'],2), number_format($deduction['Deduction'], 2));
                    }
