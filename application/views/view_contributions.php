              ...
              <div class="table-responsive">
                <?php
                  $template = array(
                    ...
                    $this->table->set_heading('Id','Contribution Date', 'Member No', 'Full Name', 'Salary','Contribution');
                    foreach ($contributions as $contribution)
                    {
                        $this->table->add_row($contribution['ContributionId'], $contribution['PaymentDate'], $contribution['MemberNo'], $contribution['FullName'], number_format($contribution['Salary'],2), number_format($contribution['Contribution'], 2));
                    }
