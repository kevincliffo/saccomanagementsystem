        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
              <div class="table-responsive">
                  <?php
                    echo form_open('admin/dodeductiontask');
                        $attributes = array(
                                'id'    => 'address_info',
                                'class' => 'address_info'
                        );

                        echo form_fieldset('<center>Employees Monthly Deduction</center>', $attributes);
                        $btn = array('class' => 'btn btn-info my-4 btn-block',
                                    'value' => 'Perform Monthly Automatic Deduction',
                                    'name' => 'submit',
                                    'type' => 'submit');
                  ...
                  echo form_close();
                    ...
                    echo form_open('admin/docontributiontask');
                        $attributes = array(
                                'id'    => 'address_info',
                                'class' => 'address_info'
                        );

                        echo form_fieldset('<center>Employees Monthly Contribution</center>', $attributes);
                        $btn = array('class' => 'btn btn-info my-4 btn-block',
                                    'value' => 'Perform Monthly Automatic Contribution',
                                    'name' => 'submit',
                                    'type' => 'submit');
                        echo '<div class="col"><div class="form-group">'.form_submit($btn).'</div></div>';   
                        echo form_fieldset_close();                  
