    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Erroneous Deductions</li>
        </ol>
          ...
          <div class="card-body">
              <div class="table-responsive">
                  ...
                  $template = array(
                    ...
                    $this->table->set_heading('Errorneous Deduction Id', 'Member No', 'Full Name', 'Amount', 'DeductionDate','CreatedDate', 'Corrected', 'Confirm');
                    foreach ($errorneousdeductions as $errorneousdeduction)
                    {
                        $data = array(
                                'name'          => $errorneousdeduction['Corrected'],
                                'id'            => 'newsletter',
                                'disabled'=>'disabled',
                                'checked'       => $errorneousdeduction['Corrected'],
                                'style'         => 'margin:10px'
                        );                          
                        $this->table->add_row($errorneousdeduction['ErrorneousDeductionId'], $errorneousdeduction['MemberNo'], $errorneousdeduction['FullName'], $errorneousdeduction['Amount'], $errorneousdeduction['DeductionDate'], $errorneousdeduction['CreatedDate'], form_checkbox($data),anchor('admin/launcherrordeduction/'.$errorneousdeduction['ErrorneousDeductionId'], 'Confirm'));
                    }
