          ...
          <div class="card-body">
            <div class="table-responsive">
                  ...
                  $template = array(
                    ...
                    $this->table->set_heading('Member Id', 'Member No', 'Full Name', 'Email', 'Birthday', 'Id No', 'Mobile', 'Address', 'Salary', 'Reg. Date', 'Confirmed', 'Confirm', 'Next of Kin');
                    foreach ($members as $member)
                    {
                        ...
                        $this->table->add_row($member['MemberId'], $member['MemberNo'], $member['FullName'], $member['Email'], $member['BirthDate'], $member['IDNumber'], $member['MobileNo'], $member['Address'], number_format($member['Salary'], 2), $member['CreatedDate'], form_checkbox($data),anchor('admin/confirmmember/'.$member['MemberId'], 'Confirm'),anchor('admin/nextofkin_single/'.$member['MemberNo'], 'Next of Kin'));
                    }
