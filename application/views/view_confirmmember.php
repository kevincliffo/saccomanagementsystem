    ...
    <body id="page-top">
        ...
        <div id="content-wrapper">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Authorize Member</li>
            </ol>

            <!-- Default form register -->
            <div class="text-center border border-light p-5">
                <H1>Authorize Member</H1>
                <?php 
                    echo form_open('admin/confirmedit');
                        echo form_hidden('memberidhidden', $member['MemberId']);
                        ...
                        $regdate = array('class' => 'form-control',
                                        'id'=>'regDate',
                                        'name'=>'regDate',
                                        'type' => 'text',
                        ...
                        echo '<div class="form-row mb-4"><div class="col">'.form_input($birthdate).'</div><div class="col">'.form_input($regdate).'</div></div>';

                        $chkconfirm = array('class' => 'custom-control-input',
                                            'id'=>'confirm',
                                            'name'=>'confirm',
                                            'value'=>1
                        );

                        $elbl = array('for' => 'confirm','class'=>'custom-control-label');                
                        echo '<div class="custom-control custom-checkbox">'.form_checkbox($chkconfirm);
                        echo form_label('Confirm Member', '', $elbl).'</div>';
                        echo '<hr>';                

                        $btn = array('class' => 'btn btn-info my-4 btn-block',
                                    'value' => 'Authorize Member',
                                    'name' => 'submit',
                                    'type' => 'submit');
